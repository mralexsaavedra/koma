  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900 transition-colors duration-300 dark:bg-gray-950 dark:text-gray-100">
      <div className="relative">
        ...
        <div className="absolute inset-0 -z-10 h-125 w-full bg-[radial-gradient(ellipse_at_top,var(--tw-gradient-stops))] from-primary-200/20 via-gray-50/0 to-transparent blur-3xl dark:from-primary-900/20 dark:via-gray-950/0" />
        ...
        <main className="container mx-auto px-4 py-8 sm:px-6 lg:px-8 xl:px-12 2xl:max-w-480">
          ...
          <section className="space-y-6">
            <div className="flex items-center justify-between px-2">
              <h2 className="font-comic text-3xl font-bold tracking-wide text-gray-800 dark:text-gray-100">
                Your Collection{" "}
