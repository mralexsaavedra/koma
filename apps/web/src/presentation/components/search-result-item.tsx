...
export const SearchResultItem = memo(
  ({ comic, isAdding, onAdd }: SearchResultItemProps) => {
    return (
      <div className="group hover:border-primary-100 hover:shadow-primary-500/5 flex items-start gap-4 rounded-2xl border border-gray-100 bg-white p-4 shadow-sm transition-all hover:shadow-lg">
